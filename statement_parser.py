...
class StatementParser:
    ...
    def parse(self, file, password: str | None = None, source: str = "statement.pdf") -> pd.DataFrame:
        ...
        best_name, best_df, best_score = None, None, (-1.0, -1)
    ...
    def _score(df: pd.DataFrame) -> tuple[float, int]:
        ...
        return (good / total if total else 0.0, len(df))
